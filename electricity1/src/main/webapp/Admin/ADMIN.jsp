                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="service.html" class="btn btn-primary py-md-2 px-md-2 me-3 animated slideInLeft">Our
                                Services</a>
                            <!-- <a href="contact.html"
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="service.html" class="btn btn-primary py-md-2 px-md-3 me-3 animated slideInLeft">Our
                                Services</a>
                            <!-- <a href="contact.html"
                                class="btn btn-outline-light py-md-2 px-md-3 animated slideInRight">Contact
                                Us</a> -->
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="single-well mar-well"><br>
                        ...
                        <p style="color:white">msebonlinebillpayment.com provides comprehensive step-by-step tutorials,
                            general tips, and answers to commonly asked questions related to the subject the website
                            cover. I hope what I present in front of you will help you to make your life easier at least
                            a tiny bit.</p>
            ...
            <div class="row gx-5" id="footer-containers">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 pt-5 mb-5">
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <p class="mb-0">Jai Ganesh Vision Office Plaza, Office No. 55, Ground Floor,‘B’
                            Building, Akurdi, Pune - 411 035. MH INDIA</p>
                    </div>
                    <div class="d-flex mb-2">
                        <i class="bi bi-envelope-open text-primary me-2"></i>
                        <p class="mb-0">www.orientconsultancy.com</p>
                    </div>
                    <div class="d-flex mb-2">
                        <i class="bi bi-envelope-open text-primary me-2"></i>
                        <p class="mb-0">info@orientconsultancy.com</p>
                    </div>
                    <div class="d-flex mb-2">
                        <i class="bi bi-telephone text-primary me-2"></i>
                        <p class="mb-0">+91 20 46703126</p>
                    </div>
                ...
                <div class="col-md-3 col-sm-4 col-xs-12 pt-0 pt-lg-5 mb-5">
                    ...
                    <div class="link-animated d-flex flex-column justify-content-start">
                        ...
                        <a class="text-light mb-2" href="service.html"><i
                                class="bi bi-arrow-right text-primary me-2"></i>Disclamer</a>
                        <a class="text-light mb-2" href="product.html"><i
                                class="bi bi-arrow-right text-primary me-2"></i>Privacy Policy</a>
                        <a class="text-light" href="career.html"><i
            ...
            <div class="row justify-content-start">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex mt-4" style="height: 60px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Copyright © 2021 <a
                                    href="index.html">MSCB</a>
                                All Rights Reserved
                        </p>
                    </div>
                </div>
