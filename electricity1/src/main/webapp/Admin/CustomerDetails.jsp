    ...
    <section id="customer-details mt-5">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10 col-xs-10" style="overflow-x:auto;font-size:14px;">
                    <h1 style="color: rgba(22, 123, 162, 0.79);" class="mb-2">Customer details</h1>
                    <table class="table table-hover">
                        ...
                        <tbody>
                          <tr>
                            <th scope="row">1</th>
                            <td>Aniket Suresh Devidas</td>
                            <td>987658909876</td>
                            <td>Devachi Alandi </td>
                            <td>Alandi</td>
                            <td>Maharashtra</td>
                            <td>aniketdevidas2018@gmail.com</td>
