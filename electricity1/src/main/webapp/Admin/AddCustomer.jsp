            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-6 mt-5">
                    ...
                    <form action="#" class="signin-form">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Customer no.</label>
                            <input type="number" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="email" placeholder="Enter customer number" required>
                        </div>
                        ...
                        <div class="form-group" style="display:flex;justify-content: space-between;">
                            ...
                            <a href="#" class="btn btn-primary w-50 mt-2" style="margin-left: 10px;">Next</a>       
                        </div>
                    </form>
