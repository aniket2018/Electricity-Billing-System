			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<div class="navbar-nav ms-auto py-0">
					...
					<a href="CustomerDetails.jsp" class="nav-item nav-link">Customer
						...
						Details</a> <a href="ConnectionRequest.jsp" class="nav-item nav-link">New
						Request</a>
		...
		<div class="container-fluid">
					...
					<div class="cards">
						...
						<div class="card">
							<input type="text" class="form-control"
								placeholder="Search Customer No" id="myInput2"
								onkeyup="myFunction2()">
						</div>
			...
			<div class="row">
				...
				<div class="col-md-10 col-xs-10"
					...
					<h1 style="color: rgba(22, 123, 162, 0.79);" class="mb-2">New
