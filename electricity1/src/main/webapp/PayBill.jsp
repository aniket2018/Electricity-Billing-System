        ...
        <div class="container-fluid">
            <div class="row">
				...
				<div class="col-md-10 col-xs-10"
					...
					<h1 style="color: rgba(22, 123, 162, 0.79);margin-top:150px;" class="mb-5 text-center">Bill
						details</h1>
					<table class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<td><a
									href="bill?id=<%=rs.getString("bill_id")%>">
										<button type="button" class="btn btn-danger delete">Pay Bill</button>
								</a></td>
