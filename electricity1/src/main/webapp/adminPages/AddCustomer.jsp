...
<head>
    <meta charset="utf-8">
    <title>AddCustomer | Electricity Billing System</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 col-xs-6 mt-5">
                    <h3 class="mb-4 text-center" style="color: rgba(22, 123, 162, 0.79);">Add New Customer</h3>
                    <form action="#" class="signin-form">

                        <div class="mb-3">
                            <label for="" class="form-label">Customer Full name</label>
                            <input type="text" class="form-control" id="" aria-describedby="emailHelp"
                                placeholder="Enter name" name="FullName" required>
                        </div>

                        <div class="mb-3">
                            <label for="" class="form-label">Mobile no.</label>
                            <input type="number" class="form-control" id="" aria-describedby="emailHelp"
                                placeholder="Enter mobile" name="Mobile" pattern="/^-?\d+\.?\d*$/"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="MeterNo" placeholder="Enter customer number/Meter No." required>
                        </div>



                        <div class="mb-3">
                            <label for="" class="form-label">Customers Address</label>
                       ...
                       <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="" aria-describedby="emailHelp"
                        placeholder="Days" name="Days" required value="30">
                       </div>

                        <div class="mb-3">
                            <label for="" class="form-label">Phase Code</label>
                            <textarea class="form-control" placeholder="Enter Phase Code" id="floatingTextarea"
                                name="PaseCode"></textarea>
                        </div>
                        

                        <div class="form-group" style="display:flex;justify-content: space-between;">
                            <a href="#" class="btn btn-primary w-50 mt-2" style="margin-right: 10px;">Cancle</a>
                            <a href="#" class="btn btn-primary w-50 mt-2" style="margin-left: 10px;">Add</a>       
                        </div>
                    </form>
                </div>
                <div class="col-md-3 col-xs-3"></div>
